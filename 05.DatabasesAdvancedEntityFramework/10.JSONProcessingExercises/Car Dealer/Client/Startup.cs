...
namespace Car_Dealer
{
    class Startup
    {
        ...
        private static void Query_6_SalesWithAppliedDiscount(CarDealershipContext context)
        {
        ...
        private static void Query_5_TotalSalesByCustomer(CarDealershipContext context)
        {
        ...
        private static void Query_4_CarsWithTheirListOfParts(CarDealershipContext context)
        {
        ...
        private static void Query_3_LocalSuppliers(CarDealershipContext context)
        {
        ...
        private static void Query_2_CarsFromMakeToyota(CarDealershipContext context)
        {
        ...
        private static void Query_1_OrderedCustomers(CarDealershipContext context)
        {
        ...
        private static void ImportCustomers(CarDealershipContext context)
        {
