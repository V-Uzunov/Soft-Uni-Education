...
namespace Products_Shop
{
    class Startup
    {
        ...
        private static void Query_4_UsersAndProducts(ShopContext context)
        {
        ...
        private static void Query_3_CategoriesByProductsCount(ShopContext context)
        {
        ...
        private static void Query_2_SuccessfullySoldProducts(ShopContext context)
        {
        ...
        private static void Query_1_ProductsInRange(ShopContext context)
        {
        ...
        private static void ImportRandomCategoryToRandomProduct(ShopContext context)
        {
        ...
        private static void ImportCategories(ShopContext context)
        {
        ...
        private static void ImportProductsWithSeller(ShopContext context)
        {
        ...
        private static void ImportUsersToDb(ShopContext context)
        {
